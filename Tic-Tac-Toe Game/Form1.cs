...
namespace Tic_Tac_Toe_Game
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Paint(object sender, PaintEventArgs e)
        {
            ...
            // Horizontal Lines
            e.Graphics.DrawLine(whitePen, 440, 280, 1050, 280);
            e.Graphics.DrawLine(whitePen, 440, 440, 1050, 440);

            // Vertical Lines
            e.Graphics.DrawLine(whitePen, 640, 120, 640, 600);
            e.Graphics.DrawLine(whitePen, 860, 120, 860, 600);
